...
class aCTATLASStatusCondor(aCTATLASProcess):
    ...
    def checkJobstoKill(self):
        ...
        - the killing of starting jobs on offline sites can be interrupted with
          a rollback

        - to be killed jobs are handled per job to ensure consistency for
          dbpanda and dbcondor
        """
